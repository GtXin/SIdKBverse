function [p,z]=BW_Meridian_Profile_2(y,add,add_profile_shape_factor,mid_point_fraction,y0,NRP_y,off_edge_y)

[z,p]=BW_Meridian_Profile_1(y,add,add_profile_shape_factor,mid_point_fraction,y0,NRP_y,off_edge_y);
