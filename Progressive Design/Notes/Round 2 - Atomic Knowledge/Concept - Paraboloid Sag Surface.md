...
A paraboloid sag surface is a quadratic local model of a curved surface. In the low-slope limit it has a constant Hessian and approximates a sphere near the vertex.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Paraboloid Sag Surface`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Paraboloid Sag Surface` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
