...
Product marking and verification workflow links removable marks, permanent engravings, power verification, prism verification, and finishing layout.
...
This Round 2 atomic note defines `Product Marking And Verification Workflow` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
