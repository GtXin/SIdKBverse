...
This bridge connects add gradient and corridor length to wearer adaptation, head/eye movement, and peripheral error.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Corridor Gradient To Clinical Adaptation`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Corridor Gradient To Clinical Adaptation` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
