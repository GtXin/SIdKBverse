...
A progressive sag surface changes curvature with position to create a distance-to-near add progression while managing lateral unwanted astigmatism.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Progressive Sag Surface`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Progressive Sag Surface` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
