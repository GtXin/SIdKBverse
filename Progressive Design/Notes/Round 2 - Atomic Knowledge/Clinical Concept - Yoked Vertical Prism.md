...
Yoked vertical prism is equal vertical prism in both eyes; it shifts the perceived world without creating vertical interocular disparity.
...
This Round 2 atomic note defines `Yoked Vertical Prism` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
