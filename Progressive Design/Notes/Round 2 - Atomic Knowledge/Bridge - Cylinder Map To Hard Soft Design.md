...
This bridge connects cylinder-map distribution to hard/soft PAL design language.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Cylinder Map To Hard Soft Design`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Cylinder Map To Hard Soft Design` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
