...
Vertical prism imbalance is the signed difference in vertical prism between eyes, creating vertical retinal disparity.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Vertical Prism Imbalance`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Vertical Prism Imbalance` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
