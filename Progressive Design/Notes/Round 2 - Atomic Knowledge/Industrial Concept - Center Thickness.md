...
Center thickness is the central lens thickness after surfacing and finishing, constrained by safety, power, material, and cosmetic requirements.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Center Thickness`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Center Thickness` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
