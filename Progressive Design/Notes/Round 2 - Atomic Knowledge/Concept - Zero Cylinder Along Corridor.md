...
Zero cylinder along the corridor is the design condition that the progressive meridian remains locally umbilical or nearly free of unwanted astigmatism.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Zero Cylinder Along Corridor`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Zero Cylinder Along Corridor` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
