...
A prism diopter is an angular deviation unit: 1 prism diopter displaces an image by 1 cm at 1 m.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Prism Diopter`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Prism Diopter` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
