...
Alignment reference marks are permanent marks used to reestablish layout and verify orientation of a PAL.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Alignment Reference Marks`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Alignment Reference Marks` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
