...
This bridge connects manufacturing prism-thinning choices to yoked prism, vertical imbalance, and binocular fusion.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Prism Thinning To Binocular Fusion`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Prism Thinning To Binocular Fusion` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
