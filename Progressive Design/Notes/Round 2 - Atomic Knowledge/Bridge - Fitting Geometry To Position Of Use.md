...
This bridge connects fitting variables such as vertex, tilt, wrap, and height to as-worn optical evaluation.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Fitting Geometry To Position Of Use`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Fitting Geometry To Position Of Use` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
