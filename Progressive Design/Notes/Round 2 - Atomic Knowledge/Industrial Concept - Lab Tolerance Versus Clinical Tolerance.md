...
Lab tolerance describes manufacturing/verification acceptance limits; clinical tolerance describes what the wearer can fuse, adapt to, or tolerate comfortably.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Lab Tolerance Versus Clinical Tolerance`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Lab Tolerance Versus Clinical Tolerance` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
