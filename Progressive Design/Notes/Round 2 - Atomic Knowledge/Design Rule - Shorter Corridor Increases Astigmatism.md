...
For a given add, a shorter corridor increases the power gradient and tends to increase lateral unwanted astigmatism.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Shorter Corridor Increases Astigmatism`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Shorter Corridor Increases Astigmatism` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
