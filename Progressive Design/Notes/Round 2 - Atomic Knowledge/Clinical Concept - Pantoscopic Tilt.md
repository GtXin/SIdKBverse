...
Pantoscopic tilt is the downward tilt of the lens plane relative to the face and eye, affecting near/intermediate viewing geometry.
...
This Round 2 atomic note defines `Pantoscopic Tilt` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
