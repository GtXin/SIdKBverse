...
A gridded surface interpolant represents a sag correction or freeform surface by interpolation over sampled grid values.
...
This Round 2 atomic note defines `Gridded Surface Interpolant` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
