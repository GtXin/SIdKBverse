...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Target Cylinder Map`. Add exact file/function references here after the code is read.
