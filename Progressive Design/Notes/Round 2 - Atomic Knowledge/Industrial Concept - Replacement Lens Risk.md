...
Replacement lens risk is the chance that one new lens does not match the remaining mate in prism-thinning, design, markings, or verification values.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Replacement Lens Risk`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Replacement Lens Risk` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
