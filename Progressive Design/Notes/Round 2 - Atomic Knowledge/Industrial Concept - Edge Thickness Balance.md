...
Edge thickness balance controls upper/lower or nasal/temporal cosmetic and mechanical thickness differences in the finished lens.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Edge Thickness Balance`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Edge Thickness Balance` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
