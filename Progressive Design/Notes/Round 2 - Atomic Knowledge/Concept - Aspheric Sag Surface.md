...
An aspheric sag surface departs from a sphere or simple toric form, often through conic constants or higher-order terms, to control aberration, thickness, or power distribution.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Aspheric Sag Surface`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Aspheric Sag Surface` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
