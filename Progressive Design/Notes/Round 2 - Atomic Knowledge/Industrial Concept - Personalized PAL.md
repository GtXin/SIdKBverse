...
A personalized PAL incorporates wearer, frame, prescription, or position-of-use parameters into the design.
...
This Round 2 atomic note defines `Personalized PAL` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
