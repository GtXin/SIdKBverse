...
This bridge connects optical surface design to blank thickness, center thickness, edge balance, and prism-thinning.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Surface Design To Manufacturing Thickness`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Surface Design To Manufacturing Thickness` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
