...
Corridor power gradient is the rate of add-power change along the corridor; it links corridor length and add magnitude to unwanted astigmatism.
...
This Round 2 atomic note defines `Corridor Power Gradient` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
