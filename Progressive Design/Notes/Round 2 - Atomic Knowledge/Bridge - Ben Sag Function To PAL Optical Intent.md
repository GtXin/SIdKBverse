...
This bridge maps Ben's sag-function parameters to PAL optical design purposes such as add profile and cylinder control.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Ben Sag Function To PAL Optical Intent`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Ben Sag Function To PAL Optical Intent` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
