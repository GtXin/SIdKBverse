...
PAL adaptation is the wearer's perceptual and motor adjustment to new power gradients, blur regions, and distortion patterns.
...
This Round 2 atomic note defines `PAL Adaptation` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
