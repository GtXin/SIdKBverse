...
This bridge maps Ben's target/weight maps to clinical zones such as distance, corridor, near, and periphery.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Ben Optimization Targets To Clinical Zones`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Ben Optimization Targets To Clinical Zones` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
