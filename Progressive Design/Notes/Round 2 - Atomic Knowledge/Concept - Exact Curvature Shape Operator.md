...
The shape operator is the exact differential-geometry object whose eigenvalues are true principal curvatures and whose eigenvectors are true principal directions.
...
During Ben-code review, search for names, comments, plots, target functions, or class methods that correspond to `Exact Curvature Shape Operator`. Add exact file/function references here after the code is read.

## Meta

### File Purpose

This Round 2 atomic note defines `Exact Curvature Shape Operator` as a reusable Obsidian knowledge point for progressive lens design. Use it as an independent reference during Ben-code inspection, clinical/application reasoning, or industrial/manufacturing review.
